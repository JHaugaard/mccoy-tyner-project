...
> **Canonical agent:** `~/.claude/agents/jazz-free-jazz-researcher.md` (self-contained, model-agnostic as of 2026-07-29 — runs under the dispatching host's model; the Opus floor was removed per John's ruling).
